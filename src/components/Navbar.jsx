            ...
            <nav className="navbar avana-navbar navbar-expand-lg">
                <div className="container-fluid d-flex justify-content-between align-items-center">
                    ...
                    <Link to="/" className="navbar-brand position-absolute top-50 start-50 translate-middle">
                        <img src="./carreras.png" alt="Avana Leather Logo" className="logo" />
                    </Link>
                    ...
                    <div className="d-flex align-items-center ms-auto">
                        ...
                        <div className="d-none d-lg-flex align-items-center">
                            ...
                            <a href="https://wa.me/573143563576" target="_blank" rel="noopener noreferrer" className="btn nav-icon-btn">
                                <i className="fa-brands fa-whatsapp"></i>
                            </a>
                        </div>
                    </div>
